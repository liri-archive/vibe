    ...
    , d_ptr(new ContainmentItemPrivate(this))
{
    ...
    // Handle elements
    connect(containment, SIGNAL(elementAdded(Hawaii::Element*)),
            this, SLOT(_q_elementAdded(Hawaii::Element*)));
...
Hawaii::Types::ContainmentType ContainmentItem::type() const
{
    Q_D(const ContainmentItem);
    return d->containment->type();
}

Hawaii::Types::FormFactor ContainmentItem::formFactor() const
{
    Q_D(const ContainmentItem);
...
Hawaii::Types::Location ContainmentItem::location() const
{
    Q_D(const ContainmentItem);
